...
function AustraliaTests() {
  const t = useTranslations('AustraliaTestPage')
        ...
        <div className="w-full h-[350px] bg-custom-light-hover-blue flex justify-center relative">
          <div className="w-[80%] h-full flex flex-col justify-center items-center gap-10">
            <div className="flex w-full justify-between">
              ...
              flex flex-col h-[240px] w-[300px] 
              text-center items-center justify-around"
              >
                <div className="font-bold text-2xl">RIDER (R)</div>
                <div className="text-sm font-normal w-[100%]">
                  {t('rDescription')}
                </div>
                <Button
                  variant="main"
                  ...
                  onClick={() => router.push(pathname + '/rider')}
                >
                  {t('startButton')}
                </Button>
              </div>
              ...
              text-center items-center justify-around"
              >
                <div className="font-bold text-2xl">CAR (C)</div>
                <div className="text-sm font-normal">{t('cDescription')}</div>
                <Button
                  variant="main"
                  size="auto"
                  className="font-medium max-w-full self-end mx-auto uppercase"
                  onClick={() => router.push(pathname + '/car')}
                >
                  {t('startButton')}
                </Button>
              </div>
              ...
              text-center items-center justify-around"
              >
                <div className="font-bold text-2xl">LIGHT RIGID (LR)</div>
                ...
                <Button
                  variant="main"
                  size="auto"
                  className="font-medium max-w-full self-end mx-auto uppercase disabled:opacity-50"
                  disabled
                >
                  {t('startButton')}
                </Button>
        ...
        <div className="h-full w-[75%] flex flex-col gap-[64px] my-4">
          <div className="flex justify-between gap-20 w-full">
            ...
            <div className="w-[50%] flex flex-col justify-center text-left gap-5">
              ...
              <div className="font-bold text-3xl">MEDIUM RIGID (MR)</div>
              <div className="text-sm font-light">{t('mrDescription')}</div>
              <Button
                variant="main"
                size="auto"
                className="font-medium uppercase max-w-[200px] disabled:opacity-50"
                disabled
              >
                {t('startButton')}
              </Button>
          ...
          <div className="w-full flex justify-between gap-20">
            <div className="w-[50%] flex flex-col justify-center text-left gap-5">
              <hr className="w-[100px] h-1 my-1 bg-purple border-0 rounded dark:bg-purple"></hr>
              <div className="font-bold text-3xl">HEAVY RIGID (HR)</div>
              <div>{t('hrDescription')}</div>
              <Button
                variant="main"
                size="auto"
                className="font-medium uppercase max-w-[200px] disabled:opacity-50"
          ...
          <div className="flex justify-between gap-20 w-full">
            ...
            <div className="w-[50%] flex flex-col justify-center text-left gap-5">
              <hr className="w-[100px] h-1 my-1 bg-purple border-0 rounded dark:bg-purple"></hr>
              <div className="font-bold text-3xl">MULTI COMBINATION (MC)</div>
              <div className="text-sm font-light">{t('mcDescription')}</div>
              <Button
                variant="main"
                size="auto"
                className="font-medium uppercase max-w-[200px] disabled:opacity-50"
          ...
          <div className="w-full flex justify-between gap-20">
            <div className="w-[50%] flex flex-col justify-center text-left gap-5">
              <hr className="w-[100px] h-1 my-1 bg-purple border-0 rounded dark:bg-purple"></hr>
              <div className="font-bold text-3xl">HEAVY COMBINATION (HC)</div>
              <div>{t('hcDescription')}</div>
              <Button
                variant="main"
                size="auto"
                className="font-medium uppercase max-w-[200px] disabled:opacity-50"
